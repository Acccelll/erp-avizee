-- ============================================================
-- ERP AviZee — Seed Completo
-- Limpeza segura das tabelas operacionais + inserção de dados
-- de exemplo realistas para testes ponta a ponta.
--
-- Cobre: cadastro → cotação → compra → financeiro → estoque → logística
-- ============================================================

-- ============================================================
-- FASE 1: LIMPEZA CONTROLADA (ordem reversa de FK)
-- ============================================================
...
-- Atualizar empresa matriz dos grupos econômicos
...
VALUES
  (
    -- 1. BioVet: fornecedor principal de seringas e vacinas
  ...
  (
    -- 2. Agro Sul: agulhas e acessórios, atraso médio de 2 dias
  ...
  (
    -- 3. Pack Rural: embalagens, entrega rápida região Campinas
  ...
  (
    -- 4. VetEquip: equipamentos veterinários, prazo maior
  ...
  (
    -- 5. Farmavias: desinfetantes e insumos, atendimento nacional
...
VALUES
  ...
  (
    ...
    2.10, 4.80, 350, 80, 0.010, '90183211', '000', '5102',
    false, 129, true
  ),
  (
    ...
    'a9a9a9a9-0009-0009-0009-000000000002', 'UN',
    2.45, 5.40, 480, 100, 0.012, '90183211', '000', '5102',
    false, 120, true
  ),
  (
    ...
    'a9a9a9a9-0009-0009-0009-000000000002', 'UN',
    2.80, 6.20, 200, 60, 0.015, '90183211', '000', '5102',
    false, 121, true
  ),
  -- Seringas (2)
  (
    ...
    28.00, 49.90, 120, 30, 0.120, '90183119', '000', '5102',
    true, 78, true
  ),
  (
    ...
    'a9a9a9a9-0009-0009-0009-000000000003', 'UN',
    38.00, 72.00, 90, 20, 0.200, '90183119', '000', '5102',
    false, 89, true
  ),
  -- Vacinas (2)
  (
    ...
    18.50, 34.90, 200, 50, 0.050, '30021900', '000', '5102',
    false, 89, true
  ),
  (
    ...
    'a9a9a9a9-0009-0009-0009-000000000001', 'FR',
    22.00, 42.50, 150, 40, 0.060, '30021900', '000', '5102',
    false, 93, true
  ),
  -- Insumos (1)
  (
    ...
    32.00, 59.90, 80, 20, 5.200, '38089410', '000', '5102',
    false, 87, true
  ),
  -- Equipamentos (1)
  (
    ...
    48.00, 89.90, 60, 15, 0.350, '39249000', '000', '5102',
    false, 87, true
  ),
  -- Reposição (1)
  (
    ...
    4.50, 9.90, 25, 10, 0.005, '73209000', '000', '5102',
    false, 120, true
  ),
  -- Kits compostos (2)
  (
    ...
    46.50, 89.90, 45, 10, 0.170, '90183119', '000', '5102',
    true, 93, true
  ),
  (
    ...
    'a9a9a9a9-0009-0009-0009-000000000006', 'KIT',
    10.40, 24.90, 30, 8, 0.029, '90279099', '000', '5102',
    true, 139, true
  )
ON CONFLICT (id) DO NOTHING;
...
-- Produtos ↔ Fornecedores (principais + secundários)
...
VALUES
  ...
  (
    ...
    'a6a6a6a6-0006-0006-0006-000000000005',
    'a5a5a5a5-0005-0005-0005-000000000001',
  ...
  (
    ...
    'a6a6a6a6-0006-0006-0006-000000000010',
    'a5a5a5a5-0005-0005-0005-000000000001',
...
VALUES
  ...
  (
    ...
    'a4a4a4a4-0004-0004-0004-000000000005',
    'a1a1a1a1-0001-0001-0001-000000000001',
...
VALUES
  (
    -- Santa Helena: preço especial em Agulha 10x10 (12,5% desconto)
  ...
  (
    -- Santa Helena: preço especial em Vacina Newcastle (14% desconto)
  ...
  (
    -- Vale Verde: preço especial em Kit Vacinação Bouba (11% desconto)
  ...
  (
    -- Continental: preço especial em Desinfetante (13% desconto)
...
VALUES
  (
    ...
    'ac01ac01-ac01-ac01-ac01-ac0100000001',
    'a6a6a6a6-0006-0006-0006-000000000001', 500, 'UN'
  ),
  (
    'ac02ac02-ac02-ac02-ac02-ac0200000002',
    'ac01ac01-ac01-ac01-ac01-ac0100000001',
    'a6a6a6a6-0006-0006-0006-000000000004', 100, 'UN'
  ),
  (
    'ac02ac02-ac02-ac02-ac02-ac0200000003',
    'ac01ac01-ac01-ac01-ac01-ac0100000002',
    'a6a6a6a6-0006-0006-0006-000000000006', 200, 'FR'
  ),
  (
    'ac02ac02-ac02-ac02-ac02-ac0200000004',
    'ac01ac01-ac01-ac01-ac01-ac0100000002',
    'a6a6a6a6-0006-0006-0006-000000000007', 150, 'FR'
  )
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (
    ...
    'b1b1b1b1-b001-b001-b001-b00100000001',
    'a6a6a6a6-0006-0006-0006-000000000001', 500, 2.10, 1050.00
  ),
  (
    'b2b2b2b2-b002-b002-b002-b00200000002',
    'b1b1b1b1-b001-b001-b001-b00100000001',
    'a6a6a6a6-0006-0006-0006-000000000002', 400, 2.45, 980.00
  ),
  (
    'b2b2b2b2-b002-b002-b002-b00200000003',
    'b1b1b1b1-b001-b001-b001-b00100000001',
    'a6a6a6a6-0006-0006-0006-000000000003', 220, 2.80, 616.00
  ),
  (
    'b2b2b2b2-b002-b002-b002-b00200000004',
    'b1b1b1b1-b001-b001-b001-b00100000002',
    'a6a6a6a6-0006-0006-0006-000000000004', 120, 28.00, 3360.00
  ),
  (
    'b2b2b2b2-b002-b002-b002-b00200000005',
    'b1b1b1b1-b001-b001-b001-b00100000002',
    'a6a6a6a6-0006-0006-0006-000000000006', 180, 18.50, 3330.00
  ),
  (
    'b2b2b2b2-b002-b002-b002-b00200000006',
    'b1b1b1b1-b001-b001-b001-b00100000003',
    'a6a6a6a6-0006-0006-0006-000000000008', 80, 32.00, 2560.00
  ),
  (
    'b2b2b2b2-b002-b002-b002-b00200000007',
    'b1b1b1b1-b001-b001-b001-b00100000004',
    'a6a6a6a6-0006-0006-0006-000000000009', 60, 48.00, 2880.00
  )
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  (
    'c2c2c2c2-c002-c002-c002-c00200000005',
    'c1c1c1c1-c001-c001-c001-c00100000002',
    'a6a6a6a6-0006-0006-0006-000000000006',
    100, 34.90, 3490.00, '', 'FR', 0.050, 5.0, 'VAC-NEWCASTLE-1000', 'Vacina Newcastle 1000D'
  ),
  (
    'c2c2c2c2-c002-c002-c002-c00200000006',
    'c1c1c1c1-c001-c001-c001-c00100000002',
    'a6a6a6a6-0006-0006-0006-000000000007',
  ...
  (
    'c2c2c2c2-c002-c002-c002-c00200000009',
    'c1c1c1c1-c001-c001-c001-c00100000004',
    'a6a6a6a6-0006-0006-0006-000000000004',
    40, 49.90, 1996.00, '', 'UN', 0.120, 4.8, 'SR-BOUBA-05', 'Seringa Bouba 0,5 mL'
  ),
  (
    'c2c2c2c2-c002-c002-c002-c00200000010',
    'c1c1c1c1-c001-c001-c001-c00100000004',
    'a6a6a6a6-0006-0006-0006-000000000006',
...
VALUES
  ...
  (
    'd2d2d2d2-d002-d002-d002-d00200000001',
    'd1d1d1d1-d001-d001-d001-d00100000001',
    'a6a6a6a6-0006-0006-0006-000000000001',
    'AG-10X10', 'Agulha Inox 10x10',
    200, 'UN', 4.20, 840.00, 0.010, 2.0, 100
  ),
  (
    'd2d2d2d2-d002-d002-d002-d00200000002',
    'd1d1d1d1-d001-d001-d001-d00100000001',
    'a6a6a6a6-0006-0006-0006-000000000004',
    'SR-BOUBA-05', 'Seringa Bouba 0,5 mL',
    80, 'UN', 49.90, 3992.00, 0.120, 9.6, 40
  ),
  (
    'd2d2d2d2-d002-d002-d002-d00200000003',
    'd1d1d1d1-d001-d001-d001-d00100000001',
    'a6a6a6a6-0006-0006-0006-000000000006',
    'VAC-NEWCASTLE-1000', 'Vacina Newcastle 1000D',
    120, 'FR', 30.00, 3600.00, 0.050, 6.0, 60
  ),
  -- OV-2026-002 (Agropecuária Vale Verde)
  (
    'd2d2d2d2-d002-d002-d002-d00200000004',
    'd1d1d1d1-d001-d001-d001-d00100000002',
    'a6a6a6a6-0006-0006-0006-000000000006',
    'VAC-NEWCASTLE-1000', 'Vacina Newcastle 1000D',
    100, 'FR', 34.90, 3490.00, 0.050, 5.0, 0
  ),
  (
    'd2d2d2d2-d002-d002-d002-d00200000005',
    'd1d1d1d1-d001-d001-d001-d00100000002',
    'a6a6a6a6-0006-0006-0006-000000000007',
    'VAC-MAREK-1000', 'Vacina Marek 1000D',
    60, 'FR', 42.50, 2550.00, 0.060, 3.6, 0
  ),
  -- OV-2026-003 (Frigorífico Continental)
  (
    'd2d2d2d2-d002-d002-d002-d00200000006',
    'd1d1d1d1-d001-d001-d001-d00100000003',
    'a6a6a6a6-0006-0006-0006-000000000008',
    'DESINF-AVIARIO-5L', 'Desinfetante Aviário 5L',
    150, 'GL', 52.00, 7800.00, 5.200, 780.0, 0
  ),
  (
    'd2d2d2d2-d002-d002-d002-d00200000007',
    'd1d1d1d1-d001-d001-d001-d00100000003',
    'a6a6a6a6-0006-0006-0006-000000000009',
    'BEB-NIPPLE-GALAO', 'Bebedouro Nipple Galão',
    80, 'UN', 89.90, 7192.00, 0.350, 28.0, 0
  )
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (
    -- NF saída: Santa Helena parcial OV-001 (1ª remessa)
  ...
  (
    -- NF saída: Vale Verde parcial OV-002
  ...
  (
    -- NF entrada: Agro Sul - COMP-2026-001 recebida
    ...
    'transferencia', 'a_prazo', null,
    '11111111-1111-1111-1111-111111111006'
  ),
  (
    -- NF entrada: BioVet - COMP-2026-002 recebida
...
VALUES
  (
    -- Baixa: recebimento Vale Verde via PIX (total)
    'f2f2f2f2-f002-f002-f002-f00200000001',
    'f1f1f1f1-f001-f001-f001-f00100000003',
    6040.00, 0, 0, 0, 0,
    '2026-03-24', 'pix',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebimento integral via PIX.'
  ),
  (
    -- Baixa: recebimento Santa Helena histórico 1
    'f2f2f2f2-f002-f002-f002-f00200000002',
    'f1f1f1f1-f001-f001-f001-f00100000005',
    8850.00, 0, 0, 0, 0,
    '2026-03-08', 'pix',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebimento via PIX - histórico PMV.'
  ),
  (
    -- Baixa: recebimento Santa Helena histórico 2
    'f2f2f2f2-f002-f002-f002-f00200000003',
    'f1f1f1f1-f001-f001-f001-f00100000006',
    6420.00, 0, 0, 0, 0,
    '2026-02-12', 'boleto',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebimento via boleto - histórico PMV.'
  ),
  (
    -- Baixa: recebimento Boa Postura antecipado com desconto (2%)
    'f2f2f2f2-f002-f002-f002-f00200000004',
    'f1f1f1f1-f001-f001-f001-f00100000007',
    3136.00, 64.00, 0, 0, 0,
    '2026-03-25', 'pix',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Antecipado com desconto de 2% = R$ 64,00.'
  ),
  (
    -- Baixa: pagamento Pack Rural
    'f2f2f2f2-f002-f002-f002-f00200000005',
    'f1f1f1f1-f001-f001-f001-f00100000012',
    2880.00, 0, 0, 0, 0,
    '2026-03-25', 'transferencia',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa002',
    'Transferência bancária no vencimento.'
  )
ON CONFLICT (id) DO NOTHING;

-- Movimentos de caixa
INSERT INTO public.caixa_movimentos (
  id, tipo, descricao, valor, data_movimento, conta_bancaria_id, observacoes, ativo
)
VALUES
  (
    'f3f3f3f3-f003-f003-f003-f00300000001',
    'entrada', 'PIX recebido - Vale Verde NF-2026-202',
    6040.00, '2026-03-24',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebimento à vista.', true
  ),
  (
    'f3f3f3f3-f003-f003-f003-f00300000002',
    'entrada', 'PIX recebido - Santa Helena CR-071',
    8850.00, '2026-03-08',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebimento histórico.', true
  ),
  (
    'f3f3f3f3-f003-f003-f003-f00300000003',
    'entrada', 'Boleto recebido - Santa Helena CR-058',
    6420.00, '2026-02-12',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebimento histórico.', true
  ),
  (
    ...
    'entrada', 'PIX recebido - Boa Postura CR-090 (c/ desconto)',
    3136.00, '2026-03-25',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa001',
    'Recebido antecipado com 2% de desconto.', true
  ),
  (
    'f3f3f3f3-f003-f003-f003-f00300000005',
    'saida', 'TED paga - Pack Rural CP-040',
    2880.00, '2026-03-25',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa002',
    'Pagamento fornecedor no vencimento.', true
  ),
  (
    'f3f3f3f3-f003-f003-f003-f00300000006',
    'saida', 'Frete entrega própria - OV-2026-001',
    200.00, '2026-03-20',
    'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaa002',
    'Custo de frete frota própria - Santa Helena.', true
  )
ON CONFLICT (id) DO NOTHING;
...
VALUES
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000001',
    'a6a6a6a6-0006-0006-0006-000000000001',
    'entrada', 500, 0, 500,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000002',
    'a6a6a6a6-0006-0006-0006-000000000002',
    'entrada', 400, 0, 400,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000003',
    'a6a6a6a6-0006-0006-0006-000000000003',
    'entrada', 220, 0, 220,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000004',
    'a6a6a6a6-0006-0006-0006-000000000004',
    'entrada', 120, 0, 120,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000005',
    'a6a6a6a6-0006-0006-0006-000000000006',
    'entrada', 180, 20, 200,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000006',
    'a6a6a6a6-0006-0006-0006-000000000001',
    'saida', 100, 500, 400,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000007',
    'a6a6a6a6-0006-0006-0006-000000000004',
    'saida', 40, 120, 80,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000008',
    'a6a6a6a6-0006-0006-0006-000000000006',
    'saida', 60, 200, 140,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000009',
    'a6a6a6a6-0006-0006-0006-000000000006',
    'saida', 60, 140, 80,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000010',
    'a6a6a6a6-0006-0006-0006-000000000007',
    'saida', 30, 180, 150,
  ...
  (
    'g1g1g1g1-g001-g001-g001-g00100000011',
    'a6a6a6a6-0006-0006-0006-000000000010',
    'ajuste', 2, 27, 25,
    'Ajuste inventário físico - Mola Êmbolo 0,5 (perda)',
    null, 'ajuste'
  ),
  (
    'g1g1g1g1-g001-g001-g001-g00100000012',
    'a6a6a6a6-0006-0006-0006-000000000012',
    'entrada', 30, 0, 30,
    'Abertura de estoque inicial - Kit Calibração',
    null, 'ajuste'
  )
ON CONFLICT (id) DO NOTHING;
...
VALUES
  (
    -- Remessa 1: OV-001 Santa Helena — entregue via frota própria
  ...
  (
    -- Remessa 2: OV-002 Vale Verde — em trânsito via Jadlog
  ...
  (
    -- Remessa 3: OV-003 Continental — postado via Jadlog
...
VALUES
  ...
  (
    'h2h2h2h2-h002-h002-h002-h00200000001',
    'h1h1h1h1-h001-h001-h001-h00100000001',
    '2026-03-20 14:00:00+00',
    'Objeto postado.', 'Campinas/SP'
  ),
  (
    'h2h2h2h2-h002-h002-h002-h00200000002',
    'h1h1h1h1-h001-h001-h001-h00100000001',
    '2026-03-21 08:30:00+00',
    'Objeto em trânsito para destino.', 'Limeira/SP'
  ),
  (
    'h2h2h2h2-h002-h002-h002-h00200000003',
    'h1h1h1h1-h001-h001-h001-h00100000001',
    '2026-03-22 10:15:00+00',
    'Objeto saiu para entrega ao destinatário.', 'Leme/SP'
  ),
  (
    'h2h2h2h2-h002-h002-h002-h00200000004',
    'h1h1h1h1-h001-h001-h001-h00100000001',
    '2026-03-22 14:50:00+00',
    'Objeto entregue ao destinatário.', 'Leme/SP'
  ),
  -- Remessa 2 (em trânsito)
  (
    'h2h2h2h2-h002-h002-h002-h00200000005',
    'h1h1h1h1-h001-h001-h001-h00100000002',
    '2026-03-24 16:00:00+00',
    'Objeto postado na agência Jadlog.', 'Campinas/SP'
  ),
  (
    'h2h2h2h2-h002-h002-h002-h00200000006',
    'h1h1h1h1-h001-h001-h001-h00100000002',
    '2026-03-25 09:00:00+00',
    'Objeto em rota para Ribeirão Preto.', 'São Paulo/SP'
  ),
  -- Remessa 3 (postado)
  (
    'h2h2h2h2-h002-h002-h002-h00200000007',
    'h1h1h1h1-h001-h001-h001-h00100000003',
