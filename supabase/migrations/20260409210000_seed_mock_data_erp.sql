-- ============================================================
-- Migração: Mock data completo do ERP AviZee
--
-- Popula todas as tabelas operacionais com dados de demonstração:
-- contas contábeis, bancos, transportadoras, formas de pagamento,
-- grupos econômicos, clientes, fornecedores, produtos,
-- cotações de compra, compras, pedidos de compra, orçamentos,
-- ordens de venda, notas fiscais, lançamentos financeiros,
-- movimentos de caixa, movimentos de estoque, remessas e
