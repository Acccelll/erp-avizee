...
const statusConfig: Record<string, { classes: string; icon: typeof Clock; label: string }> = {
  ...
  confirmado:      { classes: 'bg-warning/10 text-warning border-warning/20', icon: Clock, label: 'Ag. Aprovação' },
  confirmada:      { classes: 'bg-warning/10 text-warning border-warning/20', icon: Clock, label: 'Ag. Aprovação' },
