...
import {
  ...
  AlertTriangle, XCircle, AlarmClock, Ban
} from 'lucide-react';
...
const statusConfig: Record<string, { classes: string; icon: typeof Clock; label: string }> = {
  ...
  confirmado:   { classes: 'bg-success/10 text-success border-success/20', icon: CheckCircle, label: 'Confirmado' },
  confirmada:   { classes: 'bg-success/10 text-success border-success/20', icon: CheckCircle, label: 'Confirmada' },
